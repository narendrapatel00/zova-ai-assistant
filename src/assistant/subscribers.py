...
class LoggingSubscriber:
    ...
    def on_llm_started(self, _event: LLMStarted) -> None:
        logger.info("Sending request to Ollama")

    def on_llm_completed(self, _event: LLMCompleted) -> None:
        logger.info("Response received")

    def on_tts_started(self, _event: TTSStarted) -> None:
...
class MetricsSubscriber:
    ...
    def on_recording_finished(self, _event: RecordingFinished) -> None:
        self.metrics.stop_timer("recording_duration")
        self.metrics.start_timer("stt_latency")

    def on_stt_completed(self, _event: STTCompleted) -> None:
